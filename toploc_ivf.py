...
def get_centroid_vectors(quantizer, centroid_indices):
    """Fetch centroid vectors from the IVF quantizer."""
    d = quantizer.d
...
def toploc_ivf_search(index, q_emb, cached_centroid_indices, nprobe, k):
    """Restrict search to cached centroids."""
    ...
    #     scores, indices = index.search(q_emb, k)  # this will do a nromal search
...
for conv_id, turns in conversations.items():
    ...
    # TURNS 1+: Search within cached centroids
